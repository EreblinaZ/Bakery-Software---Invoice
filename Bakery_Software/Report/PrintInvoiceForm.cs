...
namespace Bakery_Software.Report
{
    ...
    {
        string _invoice_id;
        public PrintInvoiceForm(string _id) //konstruktor me nje parameter
        {
            _invoice_id = _id;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            string ConnectionString = "Integrated Security=SSPI; Persist Security Info=False; Initial Catalog=AB_Inventory_DB; Data Source=DESKTOP-QOPJ822 ";
            SqlConnection con = new SqlConnection(ConnectionString);
            SqlDataAdapter da = new SqlDataAdapter("select * from View_All_Bill_Test where InvoiceID = '" + txt_Invoice_ID.Text + "'", con); //e kem kriju nje view ne SQL Server e i kemi bo inner join InvoiceID me MasterID
            DataSet1 ds = new DataSet1(); //data set
            da.Fill(ds, "DataTable_Invoice"); //data adapter
